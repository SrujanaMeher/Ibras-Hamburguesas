...
<body>
      ...
      <div class="image-shader-main">
        ...
        <div class="menu-ibras">
          <ul>
            ...
            <li><a href="login.html" id='active_Link'>INICIAR SESION</a></li>
          </ul>
        </div>
  ...
  <div class="form">
    <img src="images/Burguer.png" alt="burger icon" class="burger-icon-login">
    <h3 class="description-sub-2-login">Iniciar Sesion</h3>
    <span class="close">&times;</span>
    <br><br><hr>
    <form class="login-form" action="{{URL::to('post-login')}}" method="post" onsubmit="return validateSignUp()">
       {{ csrf_field() }}
      <label for="user" id="user">Usuario:</label>
      <input type="text" name="u_name" id="userZ"/>
      <label for="password" id="password">Contraseña:</label>
      <input type="password" name="u_password" id="passwordZ" />
      <hr>
      <input type="submit" class="main-button-login" value="Entrar"><a class="user-btn">Entrar</a></button>
    </form>
  </div>
</body>
</html>
